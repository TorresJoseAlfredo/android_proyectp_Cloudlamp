...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Button btefecto, btiniciar, btapagar,btiniciartemp, btapagartemp;
    Spinner dispos_encontrados, spiner_efectos;
    String humidity;  // Hum: 70.40%
    String s_tempc,s_tempf,s_stempc,s_stempf,s_hum1,s_status_DHT;  // Temp: 19.60°C
    String heatIndex;
    ...
    TextView tempc,tempf,stempc,stempf,hum1,status_DHT;
    TextView simutemp1;
    SeekBar seekbar,seekbartemp1;
    Bitmap bitmap;
    //Trama de datos a enviar
    //(orden,r,g,b,intensidad)
    int bandera=0;
    int l0,tsimu0;
    int o=0,r,g,b,l=50,tsimu=20;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seekbartemp1 = findViewById(R.id.seekbartemp1);
        ...
        btiniciartemp = findViewById(R.id.btiniciartemp);
        btapagartemp = findViewById(R.id.btapagartemp);
        ...
        stempc = findViewById(R.id.stempc);
        stempf = findViewById(R.id.stempf);
       hum1 = findViewById(R.id.hum1);
        status_DHT = findViewById(R.id.status_DHT);
        simutemp1 = findViewById(R.id.simutemp1);
        ...
        btiniciartemp.setOnClickListener(this);
        btapagartemp.setOnClickListener(this);
            ...
            public void handleMessage(android.os.Message msg){
                if(msg.what == MESSAGE_READ){
                    ...
                    try {
                        ...
                        if (parts.length == 7) {
                            s_status_DHT = parts[0];  // Hum: 70.40%
                            s_hum1 = parts[1];  // Temp: 19.60°C
                            s_tempc = parts[2];  // Temp: 19.60°C
                            s_tempf = parts[3];  // Temp: 19.60°C
                            s_stempc = parts[4];  // Temp: 19.60°C
                            s_stempf = parts[5];  // Temp: 19.60°C
                            // Heat index: 19.45°C
                            //String s_tempc,s_tempf,s_stempc,s_stempf,s_hum1,s_status_DHT;
                    ...
                    status_DHT.setText(s_status_DHT);
                    tempc.setText(s_tempc);
                    stempc.setText(s_stempc);
                    tempf.setText(s_tempf);
                    stempf.setText(s_stempf);
                    hum1.setText(s_hum1);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN||event.getAction() == MotionEvent.ACTION_MOVE){
                    ...
                    */
                    ...
                    //set hex rgb
                    if(bandera==1){
                        MyConexionBT.writec((o+","+r+","+g+","+b+","+l+","+tsimu).toCharArray());}
        ...
        seekbartemp1.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                simutemp1.setText(String.valueOf(progress));
                tsimu0 = progress;
            }
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                tsimu=tsimu0;
                Toast.makeText(getBaseContext(), "t simulada: "+tsimu, Toast.LENGTH_SHORT).show();
                o=32;
                if(bandera==1){
                    MyConexionBT.writec((o+","+r+","+g+","+b+","+l+","+tsimu).toCharArray());}
            }
        ...
        seekbar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                l0 = progress;
               // Toast.makeText(getBaseContext(), "l0: "+l0, Toast.LENGTH_SHORT).show();
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btefecto:
                ...
                break;
            case R.id.btiniciartemp:
                o=31;
                MyConexionBT.writec((o+","+r+","+g+","+b+","+l+","+tsimu).toCharArray());
                break;
            case R.id.btapagartemp:
                o=0;
                MyConexionBT.writec((o+","+r+","+g+","+b+","+l+","+tsimu).toCharArray());
                break;
